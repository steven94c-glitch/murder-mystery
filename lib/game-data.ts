...
export const CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    secret:
      "Your family's wealth is old money, established generations ago through shipping and finance. Your inheritance is substantial — built on a legacy you didn't create. You've never had to work, never had to worry. Your life was supposed to unfold like a fairy tale: education at the right schools, marriage to the right person, children, grandchildren, a legacy of wealth and status.\n\nBut you have a secret. Much of your family's fortune comes from a vast art collection assembled by your great-grandfather — paintings that have been authenticated and insured for millions. That collection is meant to be yours. It represents your financial security, your status, your future.\n\nThen Vladimir arrived with documents proving that several pieces in your family's collection are forgeries. He discovered that your great-grandfather and grandfather had been defrauded decades ago by sophisticated art dealers. Your inheritance — the paintings you thought were priceless masterpieces — are fakes. Worth a fraction of what the insurance claims and family records state.\n\nWHAT VLADIMIR KNEW: He had documentation proving the fraudulent acquisitions. He was threatening to expose it, which would destroy your family's insurance claims, trigger legal liability, and wipe out a significant portion of your inheritance. Your financial security would collapse.\n\nSaturday afternoon, Vladimir cornered you privately and said: 'Your family's precious collection isn't what you think. I have documentation. For discretion, we should discuss terms.' He was blackmailing you. Using your inheritance as leverage.\n\nYou've been terrified all day. Arabella assured you everything would be handled. Then Vladimir died. And you understood what 'handled' meant.",
