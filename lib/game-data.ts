...
export const CHARACTERS: Character[] = [
  {
    ...
    emoji: '👑',
    role: 'Suspect',
    bio: "Arabella Ashford-Cross, 72. The legendary hostess, the arbiter of taste, the keeper of masterpieces. She's ruled Cape May's art world for forty years with impeccable taste and an iron grip on status. This weekend was supposed to be her triumph — the celebration of her greatest acquisition. She carries herself with absolute authority; people listen when she speaks. Her laugh is genuine but controlled. She has an unsettling ability to read a room and adjust her performance accordingly.\n\n*Characteristic phrases:* \"That's not how this world works,\" and \"Everything must be perfect.\" She speaks with certainty and expects obedience. She rarely admits doubt.",
    secret:
  ...
  },
  {
    ...
    emoji: '🎪',
    role: 'Observer',
    bio: "Maximilian Creed, 48. A witty, observant British playwright and director, known for sharp dialogue and darker themes. He's theatrical in manner but analytical in mind. He notices inconsistencies in people's stories and points them out with cutting humor. His laugh is sharp, his observations sharper. He speaks with a precise British accent that somehow makes accusations sound like compliments.",
    secret:
  ...
  },
  {
    ...
    emoji: '💎',
    role: 'Suspect',
    bio: "Evangeline Beaumont, 24. A young heiress with old money and minimal life experience. Sheltered, naive, beautiful in an ethereal way. She speaks softly, laughs at things she doesn't quite understand, and seems perpetually anxious. She defers to authority figures and hides her intelligence behind an air of innocence. Her background is aristocratic, her future predetermined — or at least it was before this weekend.",
    secret:
  ...
  },
  {
    ...
    emoji: '🔎',
    role: 'Suspect',
    bio: "Constantine Blackwell, 55. A private investigator and security consultant hired by wealthy clients. Quiet, meticulous, with an air of knowing more than he's saying. He observes rather than participates. His manner is precise and professional. He has a habit of asking questions that reveal inconsistencies in people's stories. He speaks deliberately, measuring each word.",
    secret:
  ...
  },
  {
    ...
    emoji: '🍷',
    role: 'Observer',
    bio: "Margot Silvain, 48. A sophisticated woman with connections to organized crime and black market operations. She moves between legitimate business and illegal enterprise with ease. She's elegant, poised, and speaks with measured precision. She notices everything and forgets nothing. Her smile is knowing.",
    secret:
